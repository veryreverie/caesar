...
harmonic_programs=(construct_matrix_force_cnsts construct_supercell min_images symmetry fourier_interpolation generate_supercells lte hartree_to_eV setup_harmonic lte_harmonic)
