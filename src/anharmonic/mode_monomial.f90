...
module mode_monomial_module
  ...
  interface construct_coupled_modes
    module procedure construct_coupled_modes_ModeMonomial
    module procedure construct_coupled_modes_RealMonomial
    module procedure construct_coupled_modes_ComplexMonomial
  end interface
contains
...
! ----------------------------------------------------------------------
! Constructs the CoupledModes corresponding to this monomial.
! ----------------------------------------------------------------------
! e.g. if this has ids [2,1,2,3,1], the corresponding CoupledModes
!    has ids [1,2,3].
impure elemental function construct_coupled_modes_ModeMonomial(this) &
   & result(output)
  implicit none
...
impure elemental function construct_coupled_modes_RealMonomial(this) &
   & result(output)
  implicit none
...
impure elemental function construct_coupled_modes_ComplexMonomial(this) &
   & result(output)
  implicit none
