...
! OLD OLD OLD
!
module old_wavevector_basis_module
  use common_module
...
function generate_old_basis(subspace,frequency,modes,qpoints, &
  ...
  type(SubspaceWavevectorBasis), allocatable :: output(:)
