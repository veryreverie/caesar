...
function core_shell_thermodynamics(thermal_energy,frequency,no_modes,bases, &
   & potential,vci_energies,anharmonic_data) result(output)
  implicit none
  ...
  real(dp),              intent(in) :: vci_energies(:)
