...
module harmonic_basis_module
  ...
  contains
    ...
    !procedure, public :: wavefunction => &
    !                   & wavefunction_HarmonicBasis
...
! Constructor.
impure elemental function new_HarmonicBasis(subspace_id,frequency) result(this)
  implicit none
...
impure elemental function initial_states_HarmonicBasis(this,subspace, &
  ...
  output = BasisStatesPointer(HarmonicStates())
end function
...
!impure elemental function wavefunction_HarmonicBasis(this,state, &
