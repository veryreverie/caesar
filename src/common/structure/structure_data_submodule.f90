submodule (caesar_structure_data_module) caesar_structure_data_submodule
  use caesar_structure_module
contains

module procedure paired_rvector_id
  output = this%rvector_paired_ids_(rvector_id)
end procedure

module procedure paired_rvector
  output = this%rvectors(this%rvector_paired_ids_(rvector_id))
end procedure

module procedure paired_gvectors
...
module procedure snap_to_symmetry_StructureData
  real(dp)             :: precision
...
module procedure write_StructureData
  type(BasicSymmetry), allocatable :: symmetries(:)
