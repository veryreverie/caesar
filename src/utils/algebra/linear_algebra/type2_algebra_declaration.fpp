! ======================================================================
! Defines various macros based on MACRO_TYPE2_NAME.
!
! MACRO_TYPE2_NAME        | integer    real        complex
! ------------------------+-------------------------------------
! MACRO_TYPE2_DECLARATION | integer    real(dp)    complex(dp)
! MACRO_TYPE2_VEC_NAME    | IntVector  RealVector  ComplexVector
! MACRO_TYPE2_MAT_NAME    | IntMatrix  RealMatrix  ComplexMatrix
! ======================================================================

! Define MACRO_TYPE2_DECLARATION
#include "type2_declaration.fpp"

! Undefine MACRO_TYPE2_VEC_NAME and MACRO_TYPE2_MAT_NAME
...
! Identify MACRO_TYPE2_NAME from integer, real and complex.
