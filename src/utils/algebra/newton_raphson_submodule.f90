submodule (caesar_newton_raphson_module) caesar_newton_raphson_submodule
...
module procedure get_inputs
  output = this%inputs_
end procedure

module procedure set_outputs
  real(dp) ::xm, x, xp
  real(dp) ::fm, f, fp
...
module procedure solution
  output = this%guesses_(size(this%guesses_))
end procedure

module procedure example_potential
...
module procedure newton_raphson_example
