...
! ----------------------------------------------------------------------
function converge_qpoint_grid() result(output)
  implicit none
...
! Main program
! ----------------------------------------------------------------------
subroutine converge_qpoint_grid_subroutine(arguments)
  implicit none
...
! ----------------------------------------------------------------------
function write_setupgrid(file_type, seedname, grid, symmetry_precision, &
