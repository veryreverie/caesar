...
! ----------------------------------------------------------------------
subroutine startup_read_normal_modes()
  implicit none
...
! Main program.
! ----------------------------------------------------------------------
subroutine read_normal_modes_subroutine(arguments)
  implicit none
...
function read_dynamical_matrices_qe(seedname,structure,large_supercell, &
...
function calculate_normal_modes(structure,qpoints,dynamical_matrices) &
   & result(output)
  implicit none
