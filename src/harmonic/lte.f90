...
function evaluate_freqs_on_grid(structure,structure_sc,force_constants,    &
  ...
  logical :: soft_modes
  real(dp) :: gvecs(3,structure_sc%sc_size)
  real(dp) :: R0(3)
  real(dp) :: GdotR
  ...
  do i=1,structure_sc%sc_size
    ...
    output%dynamical_matrices(:,:,i) = construct_dyn_matrix( gvecs(:,i),     &
                                                           & structure,      &
                                                           & structure_sc,   &
                                                           & force_constants,&
                                                           & delta_prim)
  ...
  do ig=1,structure_sc%sc_size
    ...
    do p=1,structure_sc%sc_size
      GdotR = -dot_product( &
         & gvecs(:,min(ig,structure_sc%paired_gvec(ig))), &
